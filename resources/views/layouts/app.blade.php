                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <a href="{{ route(guardName().'.dashboard') }}">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <x-jet-nav-link href="{{ route(guardName().'.dashboard') }}" :active="request()->routeIs('admin.dashboard')">
                                    {{ __('Dashboard') }}
                                </x-jet-nav-link>
                                @if(guardName()=='admin')
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-jet-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-jet-dropdown-link href="/{{ guardName() }}/profile">
                                        {{ __('Profile') }}
                                    </x-jet-dropdown-link>
                                    ...
                                    @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                                        ...
                                        <!-- Team Settings -->
                                        <x-jet-dropdown-link href="/teams/{{ $user->currentTeam->id }}">
                                            {{ __('Team Settings') }}
                                        </x-jet-dropdown-link>
                                    ...
                                    <!-- Authentication -->
                                    <form method="POST" action="{{ route(guardName().'.logout') }}">
                                        @csrf

                                        <x-jet-dropdown-link href="{{ route(guardName().'.logout') }}"
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                                ...
                                <!-- Team Settings -->
                                <x-jet-responsive-nav-link href="/teams/{{ $user->currentTeam->id }}" :active="request()->routeIs('teams.show')">
                                    {{ __('Team Settings') }}
                                </x-jet-responsive-nav-link>
